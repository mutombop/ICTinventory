    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/holders">Holders</a></li>
                    <li class="nav-item"><a class="nav-link" href="/assets">Assets</a></li>
                    <li class="nav-item"><a class="nav-link" href="/pos">Purchase Orders</a></li>
                    <li class="nav-item"><a class="nav-link disabled" href="#">PSB</a></li>
